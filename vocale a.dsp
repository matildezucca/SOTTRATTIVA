...
Ebassf1 = fi.highpass(order, fcut) : fi.lowpass(order, fcut) : *(gain) : meter 
  with{
    ...
    gain = f1group(vslider("[01] GAIN", -19, -96, +6, 0.1)) : ba.db2linear : si.smoo;
...
Ebassf3 = fi.highpass(order, fcut): fi.lowpass(order, fcut): *(gain) : meter 
  with{
    ...
    gain = f3group(vslider("[01] GAIN", +9, -96, +12, 0.1)) : ba.db2linear : si.smoo;
...
Ebassf4 = fi.highpass(order, fcut): fi.lowpass(order, fcut): *(gain) : meter 
  with{
    ...
    gain = f4group(vslider("[01] GAIN", +10, -96, +10, 0.1)) : ba.db2linear : si.smoo;
...
Ebassf5 = fi.highpass(order, fcut): fi.lowpass(order, fcut): *(gain) : meter 
  with{
    ...
    gain = f5group(vslider("[01] GAIN", -28, -96, +6, 0.1)) : ba.db2linear : si.smoo;
